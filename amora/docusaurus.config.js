...
const config = {
  ...
  url: 'https://media-marketing-amora.github.io',
  ...
  organizationName: 'media-marketing-amora', // Usually your GitHub org/user name.
  ...
  themeConfig:
    ...
    ({
      ...
      image: 'img/Tipo=Imagotipo, Cor=Colorido.svg',
      colorMode: {
